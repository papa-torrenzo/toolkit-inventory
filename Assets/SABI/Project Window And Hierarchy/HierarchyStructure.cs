...
namespace SABI
{
    ...
    {
        [MenuItem("GameObject/Create Hierarchy Structure", false, 0)]
        static void CreateHierarchyStructure()
        {
            ...
            CreateGameObjectsFromStructure(
                new HierarchyStructure("────── MANAGERS ────────────────"),
                null
            );
            CreateGameObjectsFromStructure(
                new HierarchyStructure("────── UI ─────────────────────"),
                null
            );
            CreateGameObjectsFromStructure(
                new HierarchyStructure("────── GAMEPLAY ─────────────────"),
                null
            );
            CreateGameObjectsFromStructure(
                new HierarchyStructure("────── SANDBOX ──────────────────"),
                null
            );
            CreateGameObjectsFromStructure(
