...
namespace SABI.Flow
{
    public static class VEExtensions_Align
    {
        ...
        // ---------------------------------------------------------------------------------------------
        public static T AlignItemsCenter<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T AlignItemsEnd<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T AlignItemsStart<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T AlignItemsStretch<T>(this T element)
            where T : VisualElement
        {
        ...
        // ---------------------------------------------------------------------------------------------
        public static T AlignSelfCenter<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T AlignSelfEnd<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T AlignSelfStart<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T AlignSelfStretch<T>(this T element)
            where T : VisualElement
        {
        ...
        // ---------------------------------------------------------------------------------------------
        public static T AlignContentCenter<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T AlignContentEnd<T>(this T element)
            where T : VisualElement
        {
            element.style.alignContent = Align.FlexEnd;
            return element;
        }

        public static T AlignContentStart<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T AlignContentStretch<T>(this T element)
            where T : VisualElement
        {
        ...
        // ---------------------------------------------------------------------------------------------
        public static T JustifyContentCenter<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T JustifyContentEnd<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T JustifyContentStart<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T JustifyContentSpaceAround<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T JustifyContentSpaceBetween<T>(this T element)
            where T : VisualElement
        {
        ...
        public static T JustifyContentSpaceEvenly<T>(this T element)
            where T : VisualElement
        {
            element.style.justifyContent = Justify.SpaceEvenly;
            return element;
        }
        ...
        public static T CenterF<T>(this T element)
            where T : VisualElement =>
            element.Flex().JustifyContent(Justify.Center).AlignItems(Align.Center).FlexGrow(1);

        public static T CenterT<T>(this T element)
            where T : VisualElement =>
            element.AbsolutePosition().Top(50).Left(50).Translate(-50, -50, 0);
